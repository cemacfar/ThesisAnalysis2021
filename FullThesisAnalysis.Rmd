...
#with all tests, an alpha of 0.05, no significance in bacterial alpha diversity among only frozen samples (n=21 rather than n=42 in original)
...
Fragm = plot_richness(Frozsamp,
  ...
  scale_color_manual(values = wes_palette("Darjeeling2"))
library(ggpubr)
figurealphacombo = ggarrange(Allhabitat, Fragm, nrow = 2, labels = "AUTO"); figurealphacombo
```
